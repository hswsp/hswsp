...
- [**wechat-app-zhihudaily**](https://github.com/hswsp/wechat-app-zhihudaily) - 微信小程序版的知乎日报，现在实现的比较简陋，以后随着小程序的完善，我也会完善这个项目
...
- [**blog-jekyll**](https://github.com/hswsp/blog-jekyll) - Adam Blog is a minimal clear theme for Jekyll
- [**Cnblogs-Theme-SimpleMemory**](https://github.com/hswsp/Cnblogs-Theme-SimpleMemory) - 🍭　Cnblogs theme _ Basic theme :  SimpleMemory
- [**Machine-Learning-for-Beginner-by-Python3**](https://github.com/hswsp/Machine-Learning-for-Beginner-by-Python3) - 为机器学习的入门者提供多种基于实例的sklearn、TensorFlow以及自编函数(AnFany)的ML算法程序。

### 📦 其他仓库
- [**dsh-plugins-gadget**](https://github.com/hswsp/dsh-plugins-gadget) - DeepSeek Harness（DSH）自制插件集合
